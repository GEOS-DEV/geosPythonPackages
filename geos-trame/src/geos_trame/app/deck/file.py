...
def get_origin( v: typing.Any ) -> typing.Any:
    pydantic_generic_metadata = getattr( v, "__pydantic_generic_metadata__", None )  #: PydanticGenericMetadata | None
    ...
    if type( Model ).__name__ not in processed_types:
        ...
        for k, v in Model.model_fields.items():
            ...
            if is_pydantic_model( typing.get_args( v.annotation )[ 0 ] ):
                # print("plop")
                show_hierarchy( typing.get_args( v.annotation )[ 0 ], processed_types, indent + 2 )
