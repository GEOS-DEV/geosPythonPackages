...
def test_saving_subnode_modifications( server, capsys ):
    ...
    with SB( browser="firefox" ) as sb:
        ...
        sb.driver.find_element(
            By.CSS_SELECTOR,
            "#v-list-group--id-Problem\\/NumericalMethods\\/0 .mdi-menu-right",
        ).click()
        element = sb.driver.find_element( By.CSS_SELECTOR, "body" )
        element = sb.driver.find_element(
            By.CSS_SELECTOR,
            "#v-list-group--id-Problem\\/NumericalMethods\\/0\\/FiniteVolume\\/0 .mdi-menu-right",
        )
        sb.driver.find_element(
            By.CSS_SELECTOR,
            "#v-list-group--id-Problem\\/NumericalMethods\\/0\\/FiniteVolume\\/0 .mdi-menu-right",
        ...
        element = sb.driver.find_element( By.CSS_SELECTOR, "body" )
        sb.driver.find_element( By.ID, "input-93" ).click()

        element = sb.driver.find_element( By.CSS_SELECTOR, ".mdi-content-save-outline" )
        sb.driver.find_element( By.NAME, "TwoPointFluxApproximation:upwinding_scheme:undefined" ).send_keys( "PPA" )
