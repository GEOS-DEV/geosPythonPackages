...
from paraview.simple import (  # type: ignore[import-not-found]
    AssignViewToLayout, CreateLayout, CreateView, Delete, GetLayoutByName, GetLayouts, GetViews, GetViewsInLayout,
    RemoveLayout, SetActiveView,
)
...
class DisplayOrganizationParaview:
    ...
    def addViewToLayout( self: Self, viewType: str, layout_name: str, position: int ) -> None:
    ...
    def RemoveViewFromLayout( self: Self, view_name: str, layout_name: str, position: int ) -> None:
    ...
    def SwapCellsInLayout( self: Self, layout_name: str, position1: int, position2: int ) -> None:
