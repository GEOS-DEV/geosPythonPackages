...
class TestsGeosLogReaderWells(unittest.TestCase):
    ...
    def test2_readAllSimulation3(self: Self) -> None:
        """Test reading wells with 3 wells and 1 phase."""
        obj: GeosLogReaderWells = GeosLogReaderWells(
            pathFlowSim3, conversionFactors, ["water"], 3
        )
        self.assertEqual(obj.m_phaseNames, ["water"])
        self.assertEqual(obj.m_wellNames, ["well.CO2006", "well.CO2019", "well.CO2031"])
        expectedPropertiesValues = {
            "11:Well.CO2006__BHP": [23374046.809614368, 23374046.809614368],
            "12:Well.CO2006__TotalMassRate": [81.3759820213827, 81.3759820213827],
            "13:Well.CO2006__TotalSurfaceVolumetricRate": [
                0.07189299363090057,
                0.07189299363090057,
            ],
            "11:Well.CO2019__BHP": [17957658.436823282, 17957658.436823282],
            "12:Well.CO2019__TotalMassRate": [95.12931558260858, 95.12931558260858],
            "13:Well.CO2019__TotalSurfaceVolumetricRate": [
                0.08404360979011388,
                0.08404360979011388,
            ],
            "11:Well.CO2031__BHP": [21418028.70252842, 21418028.70252842],
            "12:Well.CO2031__TotalMassRate": [95.12931558260858, 95.12931558260858],
            "13:Well.CO2031__TotalSurfaceVolumetricRate": [
                0.08404360979011388,
                0.08404360979011388,
            ],
            "15:MeanBHP": [20916577.98298869, 20916577.98298869],
            "16:MeanTotalMassRate": [90.54487106219995, 90.54487106219995],
            "17:MeanTotalVolumetricRate": [0.07999340440370944, 0.07999340440370944],
        }
        self.assertEqual(
            list(obj.m_wellsPropertiesValues.keys()),
            list(expectedPropertiesValues.keys()),
        ...
        self.assertEqual(obj.m_wellsPropertiesValues, expectedPropertiesValues)
        expectedTimesteps: list[float] = [0.0, 1.577e09]
        self.assertEqual(obj.m_timesteps, expectedTimesteps)
        expectedDF: pd.DataFrame = pd.DataFrame()
        columns_name = [
            "11:Well.CO2006__BHP__Pa",
            "12:Well.CO2006__TotalMassRate__kg/s",
            "13:Well.CO2006__TotalSurfaceVolumetricRate__m3/s",
            "11:Well.CO2019__BHP__Pa",
            "12:Well.CO2019__TotalMassRate__kg/s",
            "13:Well.CO2019__TotalSurfaceVolumetricRate__m3/s",
            "11:Well.CO2031__BHP__Pa",
            "12:Well.CO2031__TotalMassRate__kg/s",
            "13:Well.CO2031__TotalSurfaceVolumetricRate__m3/s",
            "15:MeanBHP__Pa",
            "16:MeanTotalMassRate__kg/s",
            "17:MeanTotalVolumetricRate__m3/s",
            "Time__s",
        ...
        values = [
            [23374046.809614368, 23374046.809614368],
            [81.3759820213827, 81.3759820213827],
            [0.07189299363090057, 0.07189299363090057],
            [17957658.436823282, 17957658.436823282],
            [95.12931558260858, 95.12931558260858],
            [0.08404360979011388, 0.08404360979011388],
            [21418028.70252842, 21418028.70252842],
            [95.12931558260858, 95.12931558260858],
            [0.08404360979011388, 0.08404360979011388],
            [20916577.98298869, 20916577.98298869],
            [90.54487106219995, 90.54487106219995],
            [0.07999340440370944, 0.07999340440370944],
            [0.0, 1.577e09],
        ]
        for column_name, value in zip(columns_name, values):
            expectedDF[column_name] = value
