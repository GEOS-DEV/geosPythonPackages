...
def test_supported_elements(base_name) -> None:
    ...
    supported_elements_file_name = os.path.join(
        directory, "../../../../unitTests/meshTests", base_name)
...
def make_dodecahedron() -> Tuple[vtkPoints, vtkIdList]:
    ...
    """
    points = ((1.21412, 0, 1.58931), (0.375185, 1.1547,
                                      1.58931), (-0.982247, 0.713644, 1.58931),
              (-0.982247, -0.713644, 1.58931), (0.375185, -1.1547, 1.58931),
              (1.96449, 0, 0.375185), (0.607062, 1.86835,
                                       0.375185), (-1.58931, 1.1547, 0.375185),
...
def test_parse_face_stream() -> None:
    ...
    expected = ((0, 1, 2, 3, 4), (0, 5, 10, 6, 1), (1, 6, 11, 7, 2),
