...
class TestGEOS_Table:
    ...
    def test_write_read_round_trip(self, tmp_path, sample_data):
        ...
        table_generator.write_GEOS_table(
            axes_values=sample_data["axes_values"],
        ...
        read_axes, read_properties = table_generator.read_GEOS_table(
            axes_files=sample_data["axes_names"],
