...
class GeosAtsSlurmProcessorScheduled(SlurmProcessorScheduled):
    ...
    def init(self):
        ...
        if not self.runWithSalloc:
            try:
                ...
                proc = subprocess.Popen(sinfoCmd,
                                        shell=True,
    ...
    def label(self):
        return "GeosAtsSlurmProcessorScheduled: %d nodes, %d processors per node." % (
    ...
    def checkForTimeOut(self, test):
        ...
        retval, fraction = super(GeosAtsSlurmProcessorScheduled,
                                 self).checkForTimeOut(test)
