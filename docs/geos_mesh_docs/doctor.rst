...
.. command-output:: mesh-doctor collocated_nodes --help
   :shell:
...
.. command-output:: mesh-doctor all_checks --help
   :shell:
...
.. command-output:: mesh-doctor element_volumes --help
   :shell:
...
.. command-output:: mesh-doctor fix_elements_orderings --help
   :shell:
...
.. command-output:: mesh-doctor generate_cube --help
   :shell:
...
.. command-output:: mesh-doctor generate_fractures --help
   :shell:
...
.. command-output:: mesh-doctor generate_global_ids --help
   :shell:
...
.. command-output:: mesh-doctor non_conformal --help
   :shell:
...
.. command-output:: mesh-doctor self_intersecting_elements --help
   :shell:
...
.. command-output:: mesh-doctor supported_elements --help
   :shell: