...
class TestAllChecks:
    ...
    def test_process_mesh_with_issues( self, all_checks_filter: AllChecks,
                                       simple_mesh_with_issues: vtkUnstructuredGrid ):
...
class TestMainChecks:
    ...
    def test_available_checks( self, main_checks_filter: MainChecks ):
        ...
        expected_main_checks = [ 'collocated_nodes', 'element_volumes', 'self_intersecting_elements' ]
...
class TestFilterComparison:
    ...
    def test_all_checks_vs_main_checks_availability( self, all_checks_filter: AllChecks,
                                                     main_checks_filter: MainChecks ):
