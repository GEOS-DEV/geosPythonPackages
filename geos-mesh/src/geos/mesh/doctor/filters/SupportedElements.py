...
from geos.mesh.doctor.checks.supported_elements import ( Options, find_unsupported_std_elements_types,
...
class SupportedElements( VTKPythonAlgorithmBase ):
    ...
    def RequestData(
        ...
        #     self.m_logger.info( "The following vtk polyhedron cell indexes in your mesh are not supported by GEOS:" )
