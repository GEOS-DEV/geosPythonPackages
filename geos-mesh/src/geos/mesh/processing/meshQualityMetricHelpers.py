...
class VtkCellQualityMetricEnum( CellQualityMetricEnum ):
    ...
    EDGE_RATIO = ( vtkMeshQuality.QualityMeasureTypes.EDGE_RATIO, "Edge Ratio", ( True, True, True, False, True, True ),
                   (
                       QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ),
                       QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ),
    ...
    RADIUS_RATIO = (
        ...
        "Radius Ratio",
        ( True, True, True, False, False, False ),
        ( QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ),
                        ( 1.0, np.inf ) ), QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ), ( 1.0, np.inf ) ),
          QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ), ( 1.0, np.inf ) ), None, None, None ),
    )
    ...
    ASPECT_FROBENIUS = (
        ...
        ( QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ),
                        ( 1.0, np.inf ) ), None, QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ),
                                                               ( 1.0, np.inf ) ), None, None, None ),
    )
    #: median of Aspect Frobenius over all triangles of quads / tetrahedra of hexahedron
    MEDIAN_ASPECT_FROBENIUS = ( vtkMeshQuality.QualityMeasureTypes.MED_ASPECT_FROBENIUS, "Med Aspect Frobenius",
                                ( False, True, False, False, False, True ),
                                ( None, QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ), None, None, None,
                                  QualityRange( ( 1.0, 3.0 ), ( 1.0, 3.0 ), ( 9.0, np.inf ) ) ) )
    #: maximum of Aspect Frobenius over all triangles of Quads / tetrahedra of hexahedron
    MAXIMUM_ASPECT_FROBENIUS = ( vtkMeshQuality.QualityMeasureTypes.MAX_ASPECT_FROBENIUS, "Maximum Aspect Frobenius",
                                 ( False, True, False, False, True, True ),
                                 ( None, QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ), None, None,
                                   QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ), ( 1.0, np.inf ) ),
                                   QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ), ( 1.0, np.inf ) ) ) )
    #: minimum angle between two neighboring edges for polygons / faces for tetrahedron.
    MINIMUM_ANGLE = ( vtkMeshQuality.QualityMeasureTypes.MIN_ANGLE, "Minimum Angle (°)", ( True, True, True, False,
                                                                                           False, False ),
                      ( QualityRange( ( 30.0, 60.0 ), ( 0.0, 60.0 ),
                                      ( 0.0, 360.0 ) ), QualityRange( ( 45.0, 90.0 ), ( 0.0, 90.0 ), ( 0.0, 360. ) ),
                        QualityRange( ( 40.0, 180. / np.pi * np.arccos( 1 / 3 ) ),
                                      ( 0.0, 180. / np.pi * np.arccos( 1 / 3 ) ), ( 0.0, 360.0 ) ), None, None, None ) )
    ...
    COLLAPSE_RATIO = ( vtkMeshQuality.QualityMeasureTypes.COLLAPSE_RATIO, "Collapse Ratio", ( False, False, True, False,
                                                                                              False, False ),
                       ( None, None, QualityRange( ( 0.1, 1.0 ), ( 0.0, np.inf ),
                                                   ( 0.0, np.inf ) ), None, None, None ) )
    #: maximum angle between two neighboring edges for polygons / faces for tetrahedron.
    MAXIMUM_ANGLE = ( vtkMeshQuality.QualityMeasureTypes.MAX_ANGLE, "Maximum Angle (°)",
                      ( True, True, False, False, False, False ), ( QualityRange(
                          ( 60., 90.0 ), ( 60.0, 180.0 ),
                          ( 0.0, 180.0 ) ), QualityRange( ( 90.0, 135.0 ), ( 90.0, 360.0 ),
                                                          ( 0.0, 360. ) ), None, None, None, None ) )
    ...
    CONDITION = (
        ...
        ( QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ),
                        ( 1.0, np.inf ) ), QualityRange( ( 1.0, 4.0 ), ( 1.0, 12.0 ), ( 1.0, np.inf ) ),
          QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ),
                        ( 1.0, np.inf ) ), None, QualityRange( ( 1.0, 4.0 ), ( 1.0, 12.0 ), ( 1.0, np.inf ) ),
          QualityRange( ( 1.0, 4.0 ), ( 1.0, 12.0 ), ( 1.0, np.inf ) ) ),
    )
    ...
    SCALED_JACOBIAN = (
        ...
        (
            QualityRange( ( 0.5, 2.0 * np.sqrt( 3 ) / 3.0 ), ( -2.0 * np.sqrt( 3 ) / 3.0, 2.0 * np.sqrt( 3 ) / 3.0 ),
                          ( -np.inf, np.inf ) ),
            QualityRange( ( 0.30, 1.0 ), ( -1.0, 1.0 ), ( -1.0, np.inf ) ),
            QualityRange( ( 0.5, 0.5 * np.sqrt( 2 ) ), ( -0.5 * np.sqrt( 2 ), 0.5 * np.sqrt( 2 ) ),
                          ( -np.inf, np.inf ) ),
            QualityRange( ( 0.50, 1.0 ), ( -1.0, 1.0 ), ( -1.0, np.inf ) ),
            QualityRange( ( 0.50, 1.0 ), ( -1.0, 1.0 ), ( -1.0, np.inf ) ),
            QualityRange( ( 0.50, 1.0 ), ( -1.0, 1.0 ), ( -1.0, np.inf ) ),
        ),
    )
    ...
    SHEAR = ( vtkMeshQuality.QualityMeasureTypes.SHEAR, "Shear", ( False, True, False, False, False, True ),
              ( None, QualityRange( ( 0.3, 0.6 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ), None, None, None,
                QualityRange( ( 0.3, 0.6 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ) ) )
    ...
    RELATIVE_SIZE_SQUARED = (
        ...
        ( QualityRange( ( 0.25, 0.50 ), ( 0.0, 1.0 ),
                        ( 0.0, 1.0 ) ), QualityRange( ( 0.30, 0.6 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
          QualityRange( ( 0.30, 0.50 ), ( 0.0, 1.0 ),
                        ( 0.0, 1.0 ) ), None, None, QualityRange( ( 0.50, 1.0 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ) ),
    )
    ...
    SHAPE = (
        ...
        ( True, True, True, True, True, True ),
        (
            QualityRange( ( 0.25, 0.50 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
            QualityRange( ( 0.30, 0.60 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
            QualityRange( ( 0.30, 0.60 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
            QualityRange( ( 0.30, 0.60 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
            QualityRange( ( 0.30, 0.60 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
            QualityRange( ( 0.30, 0.60 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
    ...
    DISTORTION = (
        ...
        ( True, True, True, False, True, True ),
        (
            QualityRange( ( 0.5, 1.0 ), ( 0.0, 1.0 ), ( -np.inf, np.inf ) ),
            QualityRange( ( 0.5, 1.0 ), ( 0.0, 1.0 ), ( -np.inf, np.inf ) ),
            QualityRange( ( 0.5, 1.0 ), ( 0.0, 1.0 ), ( -np.inf, np.inf ) ),
            None,
            QualityRange( ( 0.5, 1.0 ), ( 0.0, 1.0 ), ( -np.inf, np.inf ) ),
    ...
    MAXIMUM_EDGE_RATIO = ( vtkMeshQuality.QualityMeasureTypes.MAX_EDGE_RATIO, "Maximum Edge Ratio",
                           ( False, True, False, False, False, True ),
                           ( None, QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ), None, None, None,
                             QualityRange( ( 1.0, 1.3 ), ( 1.0, 3.0 ), ( 1.0, np.inf ) ) ) )
    ...
    SKEW = ( vtkMeshQuality.QualityMeasureTypes.SKEW, "Skew", ( False, True, False, False, False, True ),
             ( None, QualityRange( ( 0.5, 1.0 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ), None, None, None,
               QualityRange( ( 0.0, 0.5 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ) ) )
    ...
    TAPER = ( vtkMeshQuality.QualityMeasureTypes.TAPER, "Taper", ( False, True, False, False, False, True ),
              ( None, QualityRange( ( 0.0, 0.7 ), ( 0.0, 2.0 ), ( 0.0, np.inf ) ), None, None, None,
                QualityRange( ( 0.0, 0.5 ), ( 0.0, 1.5 ), ( 0.0, np.inf ) ) ) )
    #: polyhedron volume
    VOLUME = (
        vtkMeshQuality.QualityMeasureTypes.VOLUME,
        "Volume (m3)",
        ( False, False, True, True, True, True ),
        ( None, None, QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ), ( -np.inf, np.inf ) ),
          QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ),
                        ( -np.inf, np.inf ) ), QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ), ( -np.inf, np.inf ) ),
          QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ), ( -np.inf, np.inf ) ) ),
    )
    ...
    STRETCH = ( vtkMeshQuality.QualityMeasureTypes.STRETCH, "Stretch", ( False, True, False, False, False, True ),
                ( None, QualityRange( ( 0.25, 0.5 ), ( 0.0, 1.0 ), ( 0.0, np.inf ) ), None, None, None,
                  QualityRange( ( 0.25, 0.5 ), ( 0.0, 1.0 ), ( 0.0, np.inf ) ) ) )
    ...
    DIMENSION = ( vtkMeshQuality.QualityMeasureTypes.DIMENSION, "Dimension (m)",
                  ( False, False, False, False, False, True ), (
                      ...
                      None,
                      None,
                      QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ), ( 0.0, np.inf ) ),
                  ) )
    ...
    SHEAR_AND_SIZE = ( vtkMeshQuality.QualityMeasureTypes.SHEAR_AND_SIZE, "Shear And Size", ( False, True, False, False,
                                                                                              False, True ),
                       ( None, QualityRange( ( 0.2, 0.4 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ), None, None, None,
                         QualityRange( ( 0.2, 0.4 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ) ) )
    ...
    ASPECT_GAMMA = ( vtkMeshQuality.QualityMeasureTypes.ASPECT_GAMMA, "Aspect Gamma", ( False, False, True, False,
                                                                                        False, False ),
    ...
    AREA = (
        ...
        ( QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ),
                        ( -np.inf, np.inf ) ), QualityRange( ( 0.0, np.inf ), ( 0.0, np.inf ),
                                                             ( -np.inf, np.inf ) ), None, None, None, None ),
    )
    #: maximum of ratio of angular deviation from ideal element
    EQUIANGLE_SKEW = ( vtkMeshQuality.QualityMeasureTypes.EQUIANGLE_SKEW, "Equiangle Skew",
                       ( True, True, True, True, True, True ), (
                           QualityRange( ( 0.0, 0.5 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
                           QualityRange( ( 0.0, 0.5 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
                           QualityRange( ( 0.0, 0.5 ), ( 0.0, 1.0 ), ( 0.0, 1.0 ) ),
    ...
    EQUIVOLUME_SKEW = ( vtkMeshQuality.QualityMeasureTypes.EQUIVOLUME_SKEW, "Equivolume Skew", ( False, False, True,
                                                                                                 False, False, False ),
                        ( None, None, QualityRange( ( 0.0, 0.3 ), ( 0.0, 0.9 ), ( 0.0, 1.0 ) ), None, None, None ) )
    #: maximum stretch over tetrahedra
    MAXIMUM_STRETCH = ( vtkMeshQuality.QualityMeasureTypes.MAX_STRETCH, "Maximum Stretch",
                        ( False, False, False, False, True, False ), ( None, None, None, None,
                                                                       QualityRange( ( 0.25, 0.5 ), ( 0.0, 1.0 ),
                                                                                     ( 0.0, np.inf ) ), None ) )
    #: mean of Aspect Frobenius over all triangles of Quads / tetrahedra of hexahedron
    MEAN_ASPECT_FROBENIUS = ( vtkMeshQuality.QualityMeasureTypes.MEAN_ASPECT_FROBENIUS, "Mean Aspect Frobenius",
                              ( False, False, False, False, True, False ), ( None, None, None, None,
                                                                             QualityRange( ( 1.0, 3.0 ), ( 1.0, 9.0 ),
                                                                                           ( 1.0, np.inf ) ), None ) )
    #: ratio of tetrahedron volume over the volume of an equilateral tetrahedron with the same root mean squared edge length
    MEAN_RATIO = ( vtkMeshQuality.QualityMeasureTypes.MEAN_RATIO, "Mean Ratio",
    ...
    NODAL_JACOBIAN_RATIO = ( vtkMeshQuality.QualityMeasureTypes.NODAL_JACOBIAN_RATIO, "Nodal Jacobian Ratio",
                             ( False, False, False, False, False, True ), ( None, None, None, None, None,
                                                                            QualityRange( ( 0.0, np.inf ),
                                                                                          ( 0.0, np.inf ),
                                                                                          ( 0.0, np.inf ) ) ) )
    #: ratio of the minimum sub-triangle inner radius to the outer triangle radius
    NORMALIZED_INRADIUS = ( vtkMeshQuality.QualityMeasureTypes.NORMALIZED_INRADIUS, "Normalized Inradius",
                            ( True, False, True, False, False, False ), ( QualityRange(
                                ( 0.15, 0.5 ), ( -1.0, 1.0 ),
                                ( -1.0, 1.0 ) ), None, QualityRange( ( 0.15, 0.5 ), ( -1.0, 1.0 ),
    ...
    SQUISH_INDEX = ( vtkMeshQuality.QualityMeasureTypes.SQUISH_INDEX, "Squish Index",
...
def getQualityMeasureNameFromIndex( metricIndex: int ) -> Optional[ str ]:
...
def getQualityMeasureIndexFromName( name: str ) -> int:
    ...
    return int( vtkMeshQuality.QualityMeasureTypes.NONE )
...
def getCellQualityMeasureFromCellType( cellType: int ) -> set[ int ]:
    ...
    return {
        ...
        if metric.isApplicableToCellType( cellType )
    }
