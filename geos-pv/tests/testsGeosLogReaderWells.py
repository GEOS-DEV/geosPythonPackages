...
class TestsGeosLogReaderWells( unittest.TestCase ):
    ...
    def test1_readAllSimulation2( self: Self ) -> None:
        ...
        obj: GeosLogReaderWells = GeosLogReaderWells( pathFlowSim2, conversionFactors, [ "CO2", "water" ], 3 )
        self.assertEqual( obj.m_phaseNames, [ "CO2", "water" ] )
        self.assertEqual( obj.m_wellNames, [ "wellControls1", "wellControls2", "wellControls3" ] )
    ...
    def test3_readAllSimulation4( self: Self ) -> None:
        ...
        obj: GeosLogReaderWells = GeosLogReaderWells( pathFlowSim4, conversionFactors, [ "CO2", "water" ], 1 )
        self.assertEqual( obj.m_phaseNames, [ "CO2", "water" ] )
    ...
    def test_invalidWellName( self: Self ) -> None:
        ...
        with contextlib.redirect_stdout( capturedOutput ):
            obj: GeosLogReaderWells = GeosLogReaderWells( pathFlowSim5, conversionFactors, [ "CO2", "water" ], 1 )
